...
import reviewsLogo from '@/assets/images/review.png';
...
export default function Home() {
  return (
    <div className='container'>
      ...
      <div className='row mt-4 mx-auto justify-content-center'>
        <div className='col-md-2'>
          <Image src={serviceLogo.src} width={100} height={100} alt='services logo' />
        </div>
        <div className='col-md-6'>
          <h2>Our Services</h2>
          <ul>
      ...
      <div className='row mt-4 mx-auto justify-content-center'>
        <div className='col-md-2'>
          <Image src={reviewsLogo.src} width={100} height={100} alt='Review logo' />
        </div>
        <div className='col-md-6'>
